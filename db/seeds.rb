...
UserSkill.create(user_group_id: 1, skill_id: 1)
UserSkill.create(user_group_id: 1, skill_id: 2)
UserSkill.create(user_group_id: 1, skill_id: 3)
UserSkill.create(user_group_id: 2, skill_id: 3)
UserSkill.create(user_group_id: 2, skill_id: 4)
